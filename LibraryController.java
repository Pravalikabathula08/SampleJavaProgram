...
public class LibraryController {
    ...
    public LibraryController(ObservableList<Resource> resourceList, TableView<Resource> resourceTable) {
...
//        // ...
//
//        // Inside the result converter
//        String updatedIsbn = isbnTextField.getText();
//        String updatedIssueDate = issueDateTextField.getText();
//        String updatedGenre = genreTextField.getText();
//
//        // Update the resource properties
//        ((Book) resource).setISBN(updatedIsbn);
//        ((Magazine) resource).setIssueDate(updatedIssueDate);
//        ((CD) resource).setGenre(updatedGenre);
//
//
